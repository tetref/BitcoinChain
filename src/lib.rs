...
#[derive(Debug)]
pub struct BitcoinChainProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BitcoinChainProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BitcoinChain processing");
    
    let mut processor = BitcoinChainProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BitcoinChainProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BitcoinChainProcessor::new(false);
